...
const ROWS: PrevisionRow[] = [
  { pais: 'ARGENTINA', carteraDic: '598,8', carteraMar: '597,1', carteraVar: '-1,7', moodys: 'Caa1', sp: 'CCC+', fitch: 'CCC+', pct: 'B+', prevDic: '6,2', prevMar: '6,2', prevVar: '0,0', prevK: '10,5' },
  { pais: 'BOLIVIA', carteraDic: '431,7', carteraMar: '446,5', carteraVar: '14,8', moodys: 'Caa3', sp: 'CCC+', fitch: 'CCC', pct: 'B', prevDic: '7,8', prevMar: '6,3', prevVar: '-1,5', prevK: '14,0' },
  { pais: 'BRASIL', carteraDic: '379,0', carteraMar: '386,4', carteraVar: '7,4', moodys: 'Ba1', sp: 'BB', fitch: 'BB', pct: 'BBB', prevDic: '0,7', prevMar: '0,7', prevVar: '0,0', prevK: '1,9' },
  { pais: 'PARAGUAY', carteraDic: '455,7', carteraMar: '464,6', carteraVar: '9,0', moodys: 'Baa3', sp: 'BBB-', fitch: 'BB+', pct: 'A-', prevDic: '0,1', prevMar: '0,1', prevVar: '0,0', prevK: '0,3' },
  { pais: 'URUGUAY', carteraDic: '598,8', carteraMar: '606,7', carteraVar: '7,9', moodys: 'Baa1', sp: 'BBB+', fitch: 'BBB', pct: 'A+', prevDic: '1,9', prevMar: '1,9', prevVar: '0,0', prevK: '3,1' },
  { pais: 'Soberano', carteraDic: '2.464,1', carteraMar: '2.501,4', carteraVar: '37,3', moodys: '—', sp: '—', fitch: '—', pct: '—', prevDic: '16,8', prevMar: '15,2', prevVar: '-1,5', prevK: '6,1', kind: 'subtotal' },
  { pais: 'BADESUL', carteraDic: '30,0', carteraMar: '28,3', carteraVar: '-1,7', moodys: '—', sp: 'BB', fitch: '—', pct: 'BB+', prevDic: '0,4', prevMar: '0,4', prevVar: '0,0', prevK: '13,3' },
  { pais: 'BDMG', carteraDic: '34,0', carteraMar: '31,2', carteraVar: '-2,8', moodys: '—', sp: 'BB-', fitch: '—', pct: 'BB', prevDic: '0,7', prevMar: '0,6', prevVar: '-0,1', prevK: '19,5' },
  { pais: 'CASAN', carteraDic: '55,0', carteraMar: '55,0', carteraVar: '0,0', moodys: '—', sp: 'B+', fitch: '—', pct: 'BB-', prevDic: '1,9', prevMar: '1,9', prevVar: '0,0', prevK: '35,3' },
  { pais: 'BNF', carteraDic: '7,5', carteraMar: '6,0', carteraVar: '-1,5', moodys: '—', sp: 'BB', fitch: '—', pct: 'BB+', prevDic: '0,1', prevMar: '0,1', prevVar: '0,0', prevK: '13,3' },
  { pais: 'No Soberano', carteraDic: '126,5', carteraMar: '120,5', carteraVar: '-6,0', moodys: '—', sp: '—', fitch: '—', pct: '—', prevDic: '3,1', prevMar: '3,0', prevVar: '-0,1', prevK: '24,9', kind: 'subtotal' },
  { pais: 'Total', carteraDic: '2.590,6', carteraMar: '2.621,9', carteraVar: '31,3', moodys: '—', sp: '—', fitch: '—', pct: '—', prevDic: '19,9', prevMar: '18,2', prevVar: '-1,6', prevK: '7,0', kind: 'total' },
]
